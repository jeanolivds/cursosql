Introdução ao SQL
O que é SQL?
SQL (Structured Query Language), ou Linguagem de Consulta Estruturada, é uma linguagem de programação projetada para gerenciar e manipular bancos de dados relacionais. 
É uma linguagem padrão que permite que você interaja com sistemas de gerenciamento de banco de dados (DBMS) para realizar operações como criar, ler, atualizar e excluir dados.
